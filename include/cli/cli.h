...
namespace cli
{
    ...
    public:
        ...
        template <typename F>
        CmdHandler InsertShort(const std::string& cmdName, const std::string& shortCmdName, F f, const std::string& help = "", const std::vector<std::string>& parDesc={})
        {
            // dispatch to private Insert methods
        ...
        template <typename F>
        CmdHandler InsertShort(const std::string& cmdName, const std::string& shortCmdName, const std::vector<std::string>& parDesc, F f, const std::string& help = "")
        {
            // dispatch to private Insert methods
            return Insert(cmdName, shortCmdName, help, parDesc, f, &F::operator());
        }
